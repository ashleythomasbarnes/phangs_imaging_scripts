...
Run this with the CASA-enabled Python environment used by the PHANGS pipeline:
...
".split.fields". Field identification and splitting use the current
phangsPipeline.utilsFieldSelection implementation.
"""
